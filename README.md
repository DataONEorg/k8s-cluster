...
Documentation on the DataONE Kubernetes cluster. This repository contains operational documentation on the cluster, default configuration files for the deployments, and some [helpful utility scripts](./utils).
...
- [Important Notes on Secrets and Credentials](./storage/Ceph/Ceph-CSI.md#important-notes-on-secrets-and-credentials)
